...
<head>
    ...
    <title>H3 Sports | Connexion</title>
    ...
    <div class="w-full max-w-md">
        <div class="glass-panel p-8 sm:p-10 rounded-3xl shadow-2xl relative overflow-hidden">
            ...
            <div class="text-center mb-8">
                <h1 class="text-2xl font-serif font-bold text-white mb-2">Connectez-vous</h1>
                <p class="text-slate-400 text-sm">Accédez à votre espace athlète H3.</p>
            </div>
            ...
            <form method="POST" action="/login" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus class="input-dark w-full px-4 py-3 rounded-xl text-sm placeholder-slate-500" placeholder="votre@email.com">
                </div>
            ...
            <div class="mt-8 text-center border-t border-white/5 pt-6">
                <p class="text-slate-400 text-sm">Pas encore membre ? <a href="/register" class="text-accent-400 font-semibold hover:text-accent-300 transition-colors">Créer un compte</a></p>
            </div>
        </div>
    </div>
</body>
